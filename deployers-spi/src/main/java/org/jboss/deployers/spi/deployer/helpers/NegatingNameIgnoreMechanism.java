...
/**
 * Negate delegate's decision.
 *
 * @author <a href="mailto:ales.justin@jboss.org">Ales Justin</a>
 */
public class NegatingNameIgnoreMechanism implements NameIgnoreMechanism
{
   private NameIgnoreMechanism delegate;

   public NegatingNameIgnoreMechanism(NameIgnoreMechanism delegate)
   {
      if (delegate == null)
   ...
   {
      return delegate.ignoreName(unit, name) == false;
   }

   public boolean ignorePath(DeploymentUnit unit, String path)
   {
      return delegate.ignorePath(unit, path) == false;
   }
